...
const logos = [
  "/trosoft/logos/logo1.png",
  "/trosoft/logos/logo2.png",
  "/trosoft/logos/nivesh2.png",
  "/trosoft/logos/Fundoo.png",
  "/trosoft/logos/decor.png",
  "/trosoft/logos/academy.png",
  "/trosoft/logos/yojna.png",
  "/trosoft/logos/design.png",
  "/trosoft/logos/urban.png",
  "/trosoft/logos/wemee.png",
  "/trosoft/logos/edit.png",
];
...
const Trust = () => {
  return (
    <div className="w-full py-16 bg-white overflow-hidden">
      ...
      {/* Logos Grid */}
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-6 place-items-center px-4">
        {logos.map((logo, index) => (
          <img
            key={index}
            src={logo}
            className="w-20 h-14 sm:w-24 sm:h-16 md:w-28 md:h-20 object-contain opacity-80 hover:opacity-100 transition-all duration-300"
            alt="trusted logo"
          />
        ))}
      </div>
